        ...
        <div className='col10 sm4 md8 flexC abs BannerHyper br2 ds1'>
            <div className="col12 flexCC c7b">
                <div className="col12 pl2">
                    ...
                    <button className='btn3 br0 bn flexCC c4b c7t popupForm'><span>Register for Classes</span></button>
                </div>
            ...
            <div className="col12 flexCC c2b flex">
                <div className="col12 pl2">
                    ...
                    <button className='btn3 br0 bn flexCC c3b c7t popupForm'><span>Admission Open</span></button>
                </div>
                <div className="col12 flexRC pr">
